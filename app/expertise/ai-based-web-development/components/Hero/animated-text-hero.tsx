...
const AnimatedText: React.FC<AnimatedTextProps> = ({ texts }) => {
  ...
  return (
    <div ref={ref}>
      ...
      >
        AI-based web development can include various features
      </motion.p>
      <motion.p
        variants={FADE_UP_ANIMATION_VARIANTS}
        className="mt-6 text-lg leading-8 text-right"
      >
       like personalized recommendations, chatbots for customer service, and intelligent content management systems that adapt to
       user behavior.
      </motion.p>
    </div>
  );
