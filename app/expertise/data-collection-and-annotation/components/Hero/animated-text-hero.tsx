...
const AnimatedText: React.FC<AnimatedTextProps> = ({ texts }) => {
  ...
  return (
    <div ref={ref}>
      ...
      >
        Annotation is the process of labeling or tagging this data
      </motion.p>
      <motion.p
        variants={FADE_UP_ANIMATION_VARIANTS}
        className="mt-6 text-lg leading-8 text-right"
      >
        with meaningful information, which is crucial for training machine learning models to recognize patterns or make predictions.
      </motion.p>
    </div>
  );
};
