    ...
    >      
        ...
        <div className="relative shadow-xl bg-black/[0.6] border border-gray-900 lg:px-4 md:px-4 px-2 py-8 h-full overflow-hidden rounded-2xl items-start">
            ...
            <div className="flex flex-col xl:flex-col lg:items-center py-8">
              <span className="text-4xl md:text-5xl font-sans font-bold lg:text-5xl z-50">
                  ...
                  <CardContent>
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="item-1">
                        ...
                        <AccordionTrigger className='text-left lg:p-4 md:p-4 font-sans font-bold text-lg'>Requirement Analysis</AccordionTrigger>
                        <AccordionContent className='lg:ml-4 md:ml-4 font-sans text-lg'>                        
                        ● Understanding the type of data required,
                        source, and requirements for the project.
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="item-2">
                        <AccordionTrigger className='text-left lg:p-4 md:p-4 font-sans font-bold text-lg'>Data Collection</AccordionTrigger>
                        <AccordionContent className='lg:ml-4 md:ml-4 font-sans text-lg'>                        
                        ● Collection of data from various sources such as
                        web scraping, APIs, or data provided by clients.
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="item-3">
                        <AccordionTrigger className='text-left lg:p-4 md:p-4 font-sans font-bold text-lg'>Data Annotation</AccordionTrigger>
                        <AccordionContent className='lg:ml-4 md:ml-4 font-sans text-lg'>
                        ● Precise labeling of your data using sophisticated
                        tools and project-specific manual methods.
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="item-4">
                        <AccordionTrigger className='text-left lg:p-4 md:p-4 font-sans font-bold text-lg'>Quality Assurance</AccordionTrigger>
                        <AccordionContent className='lg:ml-4 md:ml-4 font-sans text-lg'>
                        ● Multi-layer validation to ensure the integrity of
                        the data and the accuracy of the labeling.
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="item-5">
                        <AccordionTrigger className='text-left lg:p-4 md:p-4 font-sans font-bold text-lg'>Delivery</AccordionTrigger>
                        <AccordionContent className='lg:ml-4 md:ml-4 font-sans text-lg'>
                        ● Receive the annotated dataset in your desired format,
