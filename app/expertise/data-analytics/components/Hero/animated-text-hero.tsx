...
const AnimatedText: React.FC<AnimatedTextProps> = ({ texts }) => {
  ...
  return (
    <div ref={ref}>
      ...
      >
        Harness data to drive actionable insights and strategic decisions.
      </motion.p>
      <motion.p
        variants={FADE_UP_ANIMATION_VARIANTS}
        className="mt-6 text-lg leading-8 text-right"
      >
        From advanced visualizations to predictive insights, our data analytics solutions help you make informed decisions and drive success.
      </motion.p>
    </div>
  );
};
