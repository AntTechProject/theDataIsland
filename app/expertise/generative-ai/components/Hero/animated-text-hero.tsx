    ...
    <div ref={ref}>
      ...
      >
       Generative AI can produce realistic imaGes,
        videos, or Generate human-like text. 
      </motion.p>
      <motion.p
        variants={FADE_UP_ANIMATION_VARIANTS}
        className="mt-6 text-lg leading-8 text-right"
      >
        These systems use techniques like neural networks and deep learning to generate novel outputs based on learned patterns and structures..
      </motion.p>
    </div>
  );
};
