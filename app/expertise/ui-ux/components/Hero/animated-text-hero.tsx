...
const AnimatedText: React.FC<AnimatedTextProps> = ({ texts }) => {
  ...
  return (
    <div ref={ref}>
      ...
      >
        Designing with empathy to create engaging and seamless user experiences.
        We simplify complex interactions, ensuring every touchpoint is clear and enjoyable.
      </motion.p>
    </div>
  );
};
