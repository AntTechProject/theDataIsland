...
const AnimatedText: React.FC<AnimatedTextProps> = ({ texts }) => {
  ...
  return (
    <div ref={ref}>
      ...
      >
        AI-based app development can take your AI pipeline to the next level
      </motion.p>
      <motion.p
        variants={FADE_UP_ANIMATION_VARIANTS}
        className="mt-6 text-lg leading-8 text-right"
      >
        These applications might include features such as voice recognition, predictive analytics, and personalized
        user experiences, driven by underlying AI models and algorithms.
      </motion.p>
    </div>
  );
};
